...
**Note:** If a variable is moved, `drop` is NOT called on the original variable. Structs use [Move Semantics](@/tour/08-memory-management.md#resource-semantics-move-by-default) by default.
{% end %}
